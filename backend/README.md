...
## Project Structure
    ...
    ├── testapiautodatamod_115845  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_115845`
...
2. Clone this repo and `cd testapiautodatamod_115845`
